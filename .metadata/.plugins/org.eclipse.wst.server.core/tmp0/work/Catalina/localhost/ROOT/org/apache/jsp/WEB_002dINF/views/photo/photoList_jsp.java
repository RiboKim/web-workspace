 ...
 * Generated at: 2023-02-23 00:52:49 UTC
...
if(m == null) {
      ...
      out.write("		<div class=\"page-title\">사진게시판</div>\r\n");
      out.write("		");
if(m != null) {
      out.write("\r\n");
      ...
      out.write("		\r\n");
      out.write("		</div>\r\n");
      out.write("		<button class=\"btn bc4 bs4\" id=\"more-btn\" totalCount=\"");
      ...
      out.write("			const amount = 5;//더보기 클릭했을때 추가로 가져올 게시물 수\r\n");
      out.write("			$.ajax({\r\n");
      ...
      out.write("					}\r\n");
      out.write("					//화면에 추가 완료 시점\r\n");
      out.write("					//-> 다음 더보기를 위한 값 수정\r\n");
      out.write("					const currentVal = Number($(\"#more-btn\").val()); // 속성값은 무조건 문자열이기때문에 미리 number로 형변환!!!\r\n");
      out.write("					$(\"#more-btn\").val(currentVal+amount);\r\n");
      out.write("					//currentCount값도 변경\r\n");
      out.write("					const currentCount = Number($(\"#more-btn\").attr(\"currentCount\"));\r\n");
      out.write("					const changeCount = currentCount+data.length;\r\n");
      out.write("					$(\"#more-btn\").attr(\"currentCount\",changeCount);\r\n");
      out.write("					const totalCount = Number($(\"#more-btn\").attr(\"totalCount\"));\r\n");
      out.write("					console.log(changeCount);\r\n");
      out.write("					if(changeCount == totalCount){//더 이상 불러올게 없다\r\n");
      out.write("						$(\"#more-btn\").remove();\r\n");
      out.write("					}\r\n");
      out.write("				},\r\n");
      out.write("				error : function(){\r\n");
      out.write("					console.log(\"서버요청실패\");\r\n");
      out.write("				}\r\n");
      out.write("			});\r\n");
      out.write("		});\r\n");
      out.write("		\r\n");
      out.write("		$(\"#more-btn\").click(); //처음부터 5개가 보일 수 있게\r\n");
      out.write("	</script>\r\n");
      out.write("	");
      out.write("\r\n");
      out.write("	<footer>\r\n");
