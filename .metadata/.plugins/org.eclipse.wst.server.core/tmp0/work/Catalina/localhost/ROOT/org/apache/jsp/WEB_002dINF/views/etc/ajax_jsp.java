 ...
 * Generated at: 2023-02-21 05:19:24 UTC
...
public final class ajax_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/header.jsp", Long.valueOf(1676940403100L));
...
if(m == null) {
      ...
      out.write("		<h3>1. 서버호출하기</h3>\r\n");
      out.write("		<a class=\"btn bc11\" href=\"/ajaxTest1.do\">a태그방식</a>\r\n");
      ...
      out.write("		\r\n");
      out.write("		<h3>3. 서버로 데이터 전송하고 서버에서 데이터받기(기본형 데이터받기)</h3>\r\n");
      out.write("		<input type=\"text\" id=\"su1\">\r\n");
      out.write("		<input type=\"text\" id=\"su2\">\r\n");
      out.write("		<button class=\"btn bc1\" id=\"jQ3\">더하기</button>\r\n");
      out.write("		<p class=\"ajaxResult\" id=\"result3\"></p>\r\n");
      out.write("		\r\n");
      out.write("		<h3>4. 서버로 데이터전송하고 서버에서 데이터받기(객체 받기)</h3>\r\n");
      out.write("		<input type=\"text\" id=\"input4\">\r\n");
      out.write("		<button class=\"btn bc1\" id=\"jQ4\">회원정보조회</button>\r\n");
      out.write("		<p class=\"ajaxResult\" id=\"result4\"></p>\r\n");
      out.write("		\r\n");
      out.write("		<h3>5. 서버에서 리스트 데이터 받기</h3>\r\n");
      out.write("		<button class=\"btn bc1\" id=\"jQ5\">전체회원조회</button>\r\n");
      out.write("		<p class=\"ajaxResult\" id=\"result5\"></p>\r\n");
      out.write("		\r\n");
      out.write("		<h3>6. 서버로 데이터 전송하고 서버에서 데이터받기(GSON)</h3>\r\n");
      out.write("		<input type=\"text\" id=\"input6\">\r\n");
      out.write("		<button class=\"btn bc1\" id=\"jQ6\">회원정보조회</button>\r\n");
      out.write("		<p class=\"ajaxResult\" id=\"result6\"></p>\r\n");
      out.write("		\r\n");
      out.write("		<h3>7. 서버에서 데이터 리스트 받기(GSON)</h3>\r\n");
      out.write("		<button class=\"btn bc1\" id=\"jQ7\">전체회원조회</button>\r\n");
      out.write("		<p class=\"ajaxResult\" id=\"result7\"></p>\r\n");
      out.write("	</div>\r\n");
      out.write("	<script>\r\n");
      out.write("		$(\"#js\").on(\"click\",function(){\r\n");
      out.write("			//javascript로 ajax를 이용한 서버호출방식\r\n");
      out.write("			//1.XMLHttpRequest객체 생성\r\n");
      out.write("			const xhttp = new XMLHttpRequest();\r\n");
      out.write("			//2.요청 정보 설정\r\n");
      out.write("			//method, url, 비동기여부\r\n");
      out.write("			xhttp.open(\"GET\",\"/ajaxTest1.do\",true);\r\n");
      out.write("			//3.서버 요청 처리에 따른 동작함수 지정\r\n");
      out.write("			xhttp.onreadystatechange = function(){\r\n");
      out.write("				if(this.readyState == 4 && this.status == 200){\r\n");
      out.write("					//요청이 모두 끝나고 && 정상적인 응답이 돌아온 경우\r\n");
      out.write("					console.log(\"서버 요청 성공!!\");\r\n");
      out.write("				}else if(this.readyState == 4 && this.status == 404){\r\n");
      out.write("					//요청이 모두 끝나고 && 해당 페이지를 찾을 수 없는 경우\r\n");
      ...
      out.write("				type : \"get\",\r\n");
      out.write("				data : {input1 : inputValue}, //input1이 key값이라고 생각하면 됨, 여러개 보내는것도 가능\r\n");
      out.write("				success : function(){\r\n");
      out.write("					console.log(\"서버로 데이터 전송 완료\");\r\n");
      out.write("				},\r\n");
      out.write("				error : function(){\r\n");
      out.write("					console.log(\"에러발생\");\r\n");
      out.write("				}\r\n");
      ...
      out.write("			//input에 입력된 값 2개 가져다가\r\n");
      out.write("			// /ajaxTest3.do에 전송후 출력\r\n");
      out.write("			const su1 = $(\"#su1\").val();\r\n");
      out.write("			const su2 = $(this).prev().val();\r\n");
      out.write("			$.ajax({\r\n");
      out.write("				url : \"ajaxTest3.do\",\r\n");
      out.write("				type : \"post\",\r\n");
      out.write("				data : {num1 : su1, num2 : su2},\r\n");
      out.write("				success : function(data){\r\n");
      out.write("					console.log(data, typeof data);\r\n");
      out.write("					$(\"#result3\").text(su1+\"+\"+su2+\"=\"+data);\r\n");
      out.write("					console.log(\"서버요청성공\");\r\n");
      out.write("					\r\n");
      out.write("				},\r\n");
      out.write("				error : function(){\r\n");
      out.write("					console.log(\"서버요청 실패\")\r\n");
      out.write("				}\r\n");
      out.write("			});\r\n");
      out.write("		});\r\n");
      ...
      out.write("			result.empty();//데이터가 쌓이는걸 막는거 없는 아이디를 쳐도 데이터는 쌓이니까\r\n");
      out.write("			$.ajax({\r\n");
      out.write("				url : \"/ajaxTest4.do\",\r\n");
      out.write("				type : \"get\",\r\n");
      out.write("				data : {memberId : memberId},\r\n");
      out.write("				dataType : \"JSON\", //Servlet에 안 쓸거면 여기에 쓰면 됨\r\n");
      out.write("				success : function(data){\r\n");
      ...
      out.write("						result.append(\"주소 : \"+data.memberAddr);\r\n");
      out.write("					}\r\n");
      out.write("				},\r\n");
      out.write("				error : function(){\r\n");
      out.write("					console.log(\"서버요청 실패\")\r\n");
      ...
      out.write("						div.append(\"/\");\r\n");
      out.write("						div.append(data[i].memberPhone);\r\n");
      out.write("						div.append(\"/\");\r\n");
