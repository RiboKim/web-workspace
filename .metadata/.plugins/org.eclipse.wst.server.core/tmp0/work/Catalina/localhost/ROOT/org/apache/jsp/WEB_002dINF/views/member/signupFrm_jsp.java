 ...
 * Generated at: 2023-02-21 06:18:10 UTC
...
if(m == null) {
      ...
      out.write("				<label for=\"memberId\">아이디<span id=\"ajaxCheckId\"></span></label>\r\n");
      ...
      out.write("				<input type=\"text\" name=\"memberPhone\" id=\"memberPhone\" class=\"input-form\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"input-wrap\">\r\n");
      ...
      out.write("				<button type=\"submit\" class=\"btn bc88 bs4\">회원가입</button>\r\n");
      out.write("			</div>\r\n");
      out.write("		</form>\r\n");
      out.write("	</div>\r\n");
      out.write("	<script>\r\n");
      ...
      out.write("			//정규포현식으로 아이디 정규식검사\r\n");
      out.write("			//정규식 통과되면 ajax로 중복체크\r\n");
      out.write("			$.ajax({\r\n");
      ...
      out.write("					if(data == \"1\"){\r\n");
      out.write("						$(\"#ajaxCheckId\").text(\"이미 사용중인 아이디입니다.\");\r\n");
      out.write("						$(\"#ajaxCheckId\").css(\"color\",\"red\");\r\n");
      out.write("						$(\"#memberId\").css(\"border\",\"1px solid red\");\r\n");
      out.write("					}else if(data == \"0\"){//이게 중복이 없을때니까 이때 사용가능한거\r\n");
      out.write("						$(\"#ajaxCheckId\").text(\"사용가능한 아이디입니다.\");\r\n");
      out.write("						$(\"#ajaxCheckId\").css(\"color\",\"green\");\r\n");
      out.write("						$(\"#memberId\").css(\"border\",\"1px solid green\");\r\n");
      out.write("					}\r\n");
      out.write("				}\r\n");
      out.write("			});\r\n");
      out.write("		});\r\n");
      ...
      out.write("			const memberId = $(\"#memberId\").val();\r\n");
      out.write("			if(memberId == \"\"){\r\n");
      out.write("				alert(\"아이디를 입력하세요\");\r\n");
      out.write("				return;\r\n");
      out.write("			}\r\n");
      out.write("			//숨겨놓은 form태그 내부의 input에 입력한 아이디값 세팅\r\n");
      out.write("			$(\"[name=checkId]\").val(memberId);\r\n");
      out.write("			//숨겨놓은 form을 바로 submit하면 화면이 새로 로드됨\r\n");
      out.write("			//화면이 새로 로드되면 -> 입력했던 정보가 사라짐\r\n");
      out.write("			//->새 창을 띄운 후 새 창에서 숨겨둔 form을 submit진행\r\n");
      out.write("			window.open(\"\",\"checkId\",\"left=700px,top=300px,width=300px,height=200px,menubar=no,status=no,scrollbars=yes\");\r\n");
      out.write("			//새 창과 숨겨둔 form을 연결\r\n");
