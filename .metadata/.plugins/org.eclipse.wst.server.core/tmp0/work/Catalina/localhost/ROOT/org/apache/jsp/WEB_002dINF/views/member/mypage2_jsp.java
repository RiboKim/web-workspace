 ...
 * Generated at: 2023-02-23 01:43:31 UTC
...
if(m == null) {
      ...
      out.write("		<div class=\"page-title\">마이페이지1</div>\r\n");
      out.write("		<form action=\"/updateMember2.do\" method=\"post\">\r\n");
      out.write("			<div class=\"input-wrap\">\r\n");
      out.write("				<label for=\"memberNo\">회원번호</label>\r\n");
      out.write("				<input type=\"text\" name=\"memberNo\" id=\"memberNo\" class=\"input-form\" value=\"");
      out.print(member.getMemberNo());
      out.write("\" disabled> <!--header에 있는 m을 꺼낸거-->\r\n");
      out.write("				<!-- 아예 안 쓸거 disabled, 데이터는 넘길거지만 수정은 안되게 = readonly -->\r\n");
      out.write("			</div>\r\n");
      out.write("			<div class=\"input-wrap\">\r\n");
...
if(member.getMemberLevel() == 1) {
      out.write("\r\n");
      out.write("				<input type=\"text\" name=\"memberLevel\" id=\"memberLevel\" class=\"input-form\" value=\"관리자\" disabled>\r\n");
      out.write("				");
}else if(member.getMemberLevel() == 2) {
      out.write("\r\n");
      out.write("				<input type=\"text\" name=\"memberLevel\" id=\"memberLevel\" class=\"input-form\" value=\"정회원\" disabled>\r\n");
      out.write("				");
}else if(member.getMemberLevel() == 3) {
      out.write("\r\n");
      out.write("				<input type=\"text\" name=\"memberLevel\" id=\"memberLevel\" class=\"input-form\" value=\"준회원\" disabled>\r\n");
      out.write("				");
} 
      out.write("\r\n");
      out.write("			</div>\r\n");
      ...
      out.write("				<button type=\"submit\" class=\"btn bc66 bs2\">정보수정</button>\r\n");
      out.write("				");
if(m.getMemberLevel() == 1) {
      out.write("\r\n");
      out.write("				<a class=\"btn bc6 bs2\" href=\"/adminPage.do\">회원관리</a>\r\n");
      out.write("				");
}else{ 
      out.write("\r\n");
      out.write("				<a class=\"btn bc6 bs2\" href=\"/deleteMember.do\">회원탈퇴</a>\r\n");
      out.write("				");
} 
      out.write("\r\n");
      out.write("			</div>\r\n");
