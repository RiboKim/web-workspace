 ...
 * Generated at: 2023-02-21 07:05:12 UTC
...
public final class photoWriteFrm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<style>\r\n");
      out.write("	.photoWrite th, .photoWrite td{\r\n");
...
if(m == null) {
      ...
      out.write("					<td>\r\n");
      out.write("						<input type=\"file\" name=\"imageFile\" accept=\".jpg,.png,.jpeg\" onchange=\"loadImg(this);\"> <!-- accept=\"\" 하면 이 파일들만 선택하게 만들 수 있다 -->\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr class=\"tr-1\">\r\n");
      ...
      out.write("						<button type=\"submit\" class=\"btn bc2 bs4\">등록</button>\r\n");
      out.write("					</th>\r\n");
      out.write("				</tr>\r\n");
      out.write("			</table>\r\n");
      out.write("		</form>\r\n");
      ...
      out.write("			//첨부파일이 여러개일 수 있어서 항상 배열로 처리\r\n");
      out.write("			console.log(f.files);\r\n");
      out.write("			//파일 갯수가 0개가 아니고 && 첫번째 파일이 정상파일이면\r\n");
      out.write("			if(f.files.length != 0 && f.files[0] != 0){\r\n");
      out.write("				const reader = new FileReader(); //파일정보를 얻어올 수 있는 객체\r\n");
      out.write("				//선택한 파일정보를 읽어옴\r\n");
      out.write("				reader.readAsDataURL(f.files[0]);\r\n");
      out.write("				//파일리더가 정보를 다 읽어오면 동작할 함수\r\n");
