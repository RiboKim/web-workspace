 ...
 * Generated at: 2023-02-22 05:15:14 UTC
...
public final class email_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/header.jsp", Long.valueOf(1677042274095L));
...
if(m == null) {
      ...
      out.write("		<div class=\"page-title\">EMAIL API</div>\r\n");
      out.write("		<h3>1. 이메일 전송하기</h3>\r\n");
      out.write("		<form action=\"/mailSend1.do\" method=\"post\">\r\n");
      out.write("			<table class=\"tbl\">\r\n");
      out.write("				<tr class=\"tr-1\">\r\n");
      out.write("					<th class=\"td-2\" style=\"width:20%;\">제목</th>\r\n");
      out.write("					<td>\r\n");
      out.write("						<input type=\"text\" name=\"mailTitle\" class=\"input-form\">\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr class=\"tr-1\">\r\n");
      out.write("					<th class=\"td-2\">수신자메일주소</th>\r\n");
      out.write("					<td>\r\n");
      out.write("						<input type=\"text\" name=\"receiver\" class=\"input-form\">\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<th class=\"td-2\">내용</th>\r\n");
      out.write("					<td>\r\n");
      out.write("						<textarea name=\"mailContent\" class=\"input-form\"></textarea>\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<th colspan=\"2\">\r\n");
      out.write("						<button class=\"btn bc1 bs4\" type=\"submit\">메일전송</button>\r\n");
      out.write("					</th>\r\n");
      out.write("				</tr>\r\n");
      out.write("			</table>\r\n");
      out.write("		</form>\r\n");
      out.write("		<hr>\r\n");
      out.write("		<h3>2. 이메일 인증</h3>\r\n");
      out.write("		<input type=\"text\" id=\"email\">\r\n");
      out.write("		<button class=\"btn bc1\" id=\"sendBtn\">이메일 전송</button>\r\n");
      out.write("		<div id=\"auth\" style=\"display:none;\">\r\n");
      out.write("			<input type=\"text\" id=\"authCode\" placeholder=\"인증번호\">\r\n");
      out.write("			<button class=\"btn bc1\" id=\"authBtn\">인증하기</button>\r\n");
      out.write("			<span id=\"timeZone\"></span>\r\n");
      out.write("			<span id=\"authMsg\"></span>\r\n");
      out.write("		</div>\r\n");
      out.write("	</div>\r\n");
      out.write("	<script>\r\n");
      out.write("		let mailCode;\r\n");
      out.write("		$(\"#sendBtn\").on(\"click\",function(){\r\n");
      out.write("			const email = $(\"#email\").val();\r\n");
      out.write("			$.ajax({\r\n");
      out.write("				url : \"/sendMail2.do\",\r\n");
      ...
      out.write("					}else{\r\n");
      out.write("						mailCode = data;\r\n");
      out.write("						$(\"#auth\").slideDown();\r\n");
      out.write("						authTime();\r\n");
      out.write("					}\r\n");
      out.write("				},\r\n");
      ...
      out.write("			\r\n");
      out.write("		});\r\n");
      out.write("		let intervalId;\r\n");
      out.write("		function authTime(){\r\n");
      out.write("			$(\"#timeZone\").html(\"<span id='min'>3</span> : <span id='sec'>00</span>\");\r\n");
      out.write("			intervalId = window.setInterval(function(){\r\n");
      out.write("				timecount();\r\n");
      out.write("			},1000)\r\n");
      out.write("		}\r\n");
      out.write("		function timecount(){\r\n");
      out.write("			const min = $(\"#min\").text();\r\n");
      out.write("			const sec = $(\"#sec\").text();\r\n");
      out.write("			if(sec == \"00\"){\r\n");
      out.write("					if(min != \"0\"){\r\n");
      out.write("						const newMin = Number(min) - 1;\r\n");
      out.write("						$(\"#min\").text(newMin);\r\n");
      out.write("						$(\"#sec\").text(59);\r\n");
      out.write("					}else{\r\n");
      out.write("						window.clearInterval(intervalId);\r\n");
      out.write("						mailCode = null;\r\n");
      out.write("						$(\"#authMsg\").text(\"인증시간만료\");\r\n");
      out.write("						$(\"#authMsg\").css(\"color\",\"red\");\r\n");
      out.write("					}\r\n");
      out.write("				\r\n");
      out.write("			}else{\r\n");
      out.write("				const newSec = Number(sec) - 1;\r\n");
      out.write("				if(newSec<10){\r\n");
      out.write("					$(\"#sec\").text(\"0\"+newSec);\r\n");
      out.write("				}else{\r\n");
      out.write("					$(\"#sec\").text(newSec);\r\n");
      out.write("				}\r\n");
      out.write("				\r\n");
      out.write("			}\r\n");
      out.write("		}\r\n");
      out.write("		$(\"#authBtn\").on(\"click\",function(){\r\n");
      out.write("			if(mailCode == null){\r\n");
      out.write("				$(\"#authMsg\").text(\"인증시간만료\");\r\n");
      out.write("				$(\"#authMsg\").css(\"color\",\"red\");\r\n");
      out.write("			}else{\r\n");
      out.write("				const authCode = $(\"#authCode\").val();\r\n");
      out.write("				if(mailCode == authCode){\r\n");
      out.write("					$(\"#authCode\").prop(\"readonly\",true); //더 이상 인증코드 못 바꾸게 하는거\r\n");
      out.write("					$(\"#authMsg\").text(\"인증완료\");\r\n");
      out.write("					$(\"#authMsg\").css(\"color\",\"blue\");\r\n");
      out.write("					window.clearInterval(intervalId);\r\n");
      out.write("				}else{\r\n");
      out.write("					$(\"#authMsg\").text(\"인증실패\");\r\n");
      out.write("					$(\"#authMsg\").css(\"color\",\"red\");\r\n");
      out.write("				}\r\n");
      out.write("			}\r\n");
      out.write("		})\r\n");
