 ...
 * Generated at: 2023-02-20 02:53:18 UTC
...
if(member.getMemberLevel() == 1) {
      ...
      out.write("				<button class=\"btc bc22 bs4 checkedChangeLevel\">선택회원등급변경</button>\r\n");
      out.write("			</th>\r\n");
      out.write("		</tr>\r\n");
      out.write("		</table>\r\n");
      out.write("	</div>\r\n");
      ...
      out.write("			//회원등급에 필요한 정보는 수집 끝(회원번호, 선택한 등급)\r\n");
      out.write("			//-> 서버에 update 요청(1.form, 2. a)\r\n");
      out.write("			//-> <a href=\"/서블릿주소?key1=value1 & key2=value2\" 요렇게 두개를 넘겨주겠다는 뜻 -> location.href\r\n");
      ...
      out.write("				return;\r\n");
      out.write("				}\r\n");
      out.write("				//체크된 회원번호를 저장할 배열\r\n");
      out.write("				const no = new Array();\r\n");
      out.write("				//체크된 회원의 등급을 저장할 배열\r\n");
      out.write("				const level = new Array();\r\n");
      out.write("				//체크된 체크박스 기준으로 회원번호, 등급을 찾아서 배열에 넣는다\r\n");
      out.write("				check.each(function(index,item){\r\n");
      out.write("					const memberNo = $(item).parent().next().text();\r\n");
      out.write("					no.push(memberNo);\r\n");
      out.write("					const memberLevel = $(item).parent().parent().find(\"select\").val();\r\n");
      out.write("					level.push(memberLevel);\r\n");
      out.write("				});\r\n");
      out.write("				location.href=\"/checkedChangeLevel.do?no=\"+no.join(\"/\")+\"&level=\"+level.join(\"/\");				\r\n");
      out.write("		});\r\n");
      out.write("	</script>\r\n");
      out.write("	");
      out.write("\r\n");
