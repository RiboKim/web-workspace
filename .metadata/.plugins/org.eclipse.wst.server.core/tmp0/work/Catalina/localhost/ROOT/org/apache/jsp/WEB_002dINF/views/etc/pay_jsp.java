 ...
 * Generated at: 2023-02-22 08:18:53 UTC
...
if(m == null) {
      ...
      out.write("		<div class=\"page-title\">결제모듈</div>\r\n");
      out.write("		<input type=\"text\" id=\"pay\">\r\n");
      out.write("		<button id=\"payBtn\" class=\"btn bc1\">결제하기</button>\r\n");
      out.write("	</div>\r\n");
      out.write("	\r\n");
      out.write("<script>\r\n");
      out.write("	$(\"#payBtn\").on(\"click\",function(){\r\n");
      out.write("		const price = $(\"#pay\").val();\r\n");
      out.write("		const d = new Date();\r\n");
      out.write("		const date = d.getFullYear()+\"\"+(d.getMonth()+1)+\"\"+d.getDate()\r\n");
      out.write("					+\"\"+d.getHours()+\"\"+d.getMinutes()+\"\"+d.getSeconds();\r\n");
      out.write("		\r\n");
      out.write("		IMP.init(\"imp72580518\");\r\n");
      out.write("		\r\n");
      out.write("		IMP.request_pay({\r\n");
      out.write("			pg : \"html5_inicis\",\r\n");
      out.write("			pay_method : \"card\",\r\n");
      out.write("			merchant_uid : \"상품번호_\"+date,//상점에서 관리하는 주문번호 겹치지 않게 하려고 시,분,초 까지 끌어온거\r\n");
      out.write("			name : \"결제 테스트\",		//결제이름\r\n");
      out.write("			amount : price,			//결제금액\r\n");
      out.write("			buyer_email : \"kingodribo@gmail.com\",\r\n");
      out.write("			buyer_name : \"구매자\",\r\n");
      out.write("			buyer_tel : \"010-1111-2222\",\r\n");
      out.write("			buyer_addr : \"서울시 영등포구 당산동\",\r\n");
      out.write("			buyer_postcode : \"12345\"\r\n");
